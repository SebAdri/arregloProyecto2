...
<form method="post" action="{{ route('reportePagoPdf') }}">
  {!! csrf_field() !!}
  <div class="container">
    <div class="row">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h1>Pagos por Obra</h1>
        </div>
        ...
        <div class="panel-body">
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="input-group">
                <label class="radio-inline"><input type="radio" name="estado">Todos</label>
                <label class="radio-inline"><input type="radio" value=1 name="estado">Pendiente</label>
                <label class="radio-inline"><input type="radio" value=2 name="estado">Pagado</label>
          ...
          <div class="row">
            <div class="col-md-5 col-md-offset-5">
              <input class="btn button-primary" formtarget="_blank" value="Generar Reporte" type="submit">
            </div>
          </div>
        </div>
      </div>
