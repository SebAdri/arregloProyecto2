...
@section('contenido')
<form method="GET" action="{{ route('exportarPdf') }}">
	{{csrf_field()}}
	<div class="x_panel">
		...
		<div class="col-md-9 col-md-offset-3">
			...
			<button type="submit" class="btn btn-info" id="submitReporteAvance" name="submitReporteAvance" value="2">Exportar a PDF</button>
